 ...
 */
const config = {
  title: "m的小站",                 //write your website title
  subtitle: "地区：cloudflare", //write your website subtitle
  ...
  sell_info:{
    domain:"m",
    price:"你好",                        //domain price
    mon_unit:"",              //monetary unit 
    contact:[                         //how to contact you
      {
        type:"weixin",               //contact type ("weixin","qq","telegram plane","envelope" or "phone")
        content:"ingm23"
      }
    ]                        
  },
  lists: [                            //Url list
    {
      ...
      list:[
        {
          url:"http://www.jasas.eu.org/",
          name:"小站入口",
          desc:"跳转网页"
        },
        {
          url:"http://www.jasas.eu.org/?p=posts/3.html",
          name:"测速",
          desc:"在线测速"
        },
        {
          url:"http://www.jasas.eu.org/?p=posts/jdc.html",
          name:"京豆车",
          desc:"相关教程"
        },
        /*{
...
function renderHeader(){
  ...
  return el('header',[],el('div',['id="head"','class="ui inverted vertical masthead center aligned segment"'],(config.hitokoto ? el('div',['id="nav"','class="ui container"'],nav) : "") + el('div',['id="title"','class="ui text container"'],title + (config.search ? input + menu :"") + `${config.selling_ads ? '<div><a id="menubtn" class="red ui icon inverted button"><i class="heart icon"></i> 联系方式 </a></div>' : ''}`)))
}
...
function renderSeller() {
  ...
  var title = el('h1',['class="ui yellow dividing header"'],el('i',['class="gem outline icon"'],"") + el('div',['class="content"'],config.sell_info.domain + ' 的联系方式'));
